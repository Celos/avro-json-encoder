...
public class ExtendedJsonEncoder extends ParsingEncoder implements Parser.ActionHandler {
	 ...
	 */
	public ExtendedJsonEncoder configure(OutputStream out) throws IOException {
	 ...
	 */
	@Deprecated
	public ExtendedJsonEncoder configure(JsonGenerator generator) throws IOException {
		if (null == generator)
